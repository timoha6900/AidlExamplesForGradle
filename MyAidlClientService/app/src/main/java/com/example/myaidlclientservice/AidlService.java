...
public class AidlService extends Service {
	...
	private final String[] weatherTypes = new String[] {
		...
		public void handleMessage(Message msg) {
			switch (msg.what) {
				case REPORT_MSG:
					...
					weather.setType(weatherTypes[(int)(Math.random()*6)]);
					weather.setTemperature((int)(Math.random()*80 - 40));
					...
					for(int i = 0; i < N; i++) {
						try{
							mCallbacks.getBroadcastItem(i).valueChanged(bundle);
